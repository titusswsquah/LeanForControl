...
<!-- verify: LEAN (phase A): the antistable half (Sigma_inf|aa>0) = DareSystem.strong_corner_posDef (marginal-inclusive, same declaration as lem:structure-1); extinction Sigma_inf|.m = 0: pending. -->
